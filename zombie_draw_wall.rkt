...
(define players 50)
(struct wall-coords (i j w h))   ;; Global structure to hold the dimensions of the wall
...
;______MOUSE CONTROL____________________________________________________________________________
...
(define get-wall mouse-handle) ;; has an issue here where it tries to create the wall before it's drawn.  I've been unable to remedy this.

;(define get-wall (wall-coords 200 50 20 50)) ;simple define to create a wall using the global struct
